...
function KidsShoes() {
  ...
  // Filter products to get only the ones with category "Kids Shoes"
  const KidsShoesProducts = ProductsData.filter(product => product.category === "Kids Shoes");
  ...
  const filteredProducts = KidsShoesProducts.filter(product => {
  ...
  const categoryToShow = KidsShoesProducts.length > 0 ? KidsShoesProducts[0].category : '';
