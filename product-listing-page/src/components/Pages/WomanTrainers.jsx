...
function WomanTrainers() {
  ...
  // Filter products to get only the ones with category "Woman Trainers"
  const womanTrainersProducts = ProductsData.filter(product => product.category === "Woman Trainers");
  ...
  const filteredProducts = womanTrainersProducts.filter(product => {
  ...
  const categoryToShow = womanTrainersProducts.length > 0 ? womanTrainersProducts[0].category : '';
