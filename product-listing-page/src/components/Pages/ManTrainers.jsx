...
function ManTrainers() {
  ...
  // Filter products to get only the ones with category "Man Trainers"
  const manTrainersProducts = ProductsData.filter(product => product.category === "Man Trainers");
  ...
  const categoryToShow = manTrainersProducts.length > 0 ? manTrainersProducts[0].category : '';
